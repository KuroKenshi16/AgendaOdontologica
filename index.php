    ...
    <div class="navbar">
        <div class="max-width">
            ...
            <ul class="menu">
                ...
                <li>
                    <a class="nav-link" href="src/definir-horarios/view/definir-horarios.html">Definir Agenda</a>
                </li>
                <li>
                    <a class="nav-link" href="src/cadastro/view/cadUser.html">Dados Pessoais</a>
                </li>
                <li>
    ...
    <section class="home" id="home">
        <div class="max-width">
            <div class="home-content">
                ...
                <a class="nav-link" href="src/agendamento/view/agendamento.html">Agendar</a>
            </div>
        </div>
    </section>
